...
public class ReplyCommentKey {
    ...
    @PrimaryKeyColumn(value = "reply_comment_id", ordinal = 2, type = PrimaryKeyType.CLUSTERED, ordering = Ordering.ASCENDING)
    private UUID replyCommentId;

    @PrimaryKeyColumn(value = "creation_date_time", ordinal = 3, type = PrimaryKeyType.CLUSTERED, ordering = Ordering.DESCENDING)
